@customfield @customfield_multiselect @javascript
Feature: Managers can manage course custom fields Multiselect
  ...
  Scenario: Create a custom course multiselect field
    ...
    b
    """
    And I click on "Save changes" "button" in the "Adding a new Multiselect menu" "dialogue"
    Then I should see "Test field"
    And I log out

  Scenario: Edit a custom course multiselect field
    When I click on "Add a new custom field" "link"
    And I click on "Multiselect menu" "link"
    And I set the following fields to these values:
      | Name       | Test field |
  ...
  Scenario: Delete a custom course multiselect field
    When I click on "Add a new custom field" "link"
    And I click on "Multiselect menu" "link"
    And I set the following fields to these values:
      | Name       | Test field |
  ...
  Scenario: Validation of custom course multiselect field configuration
    When I click on "Add a new custom field" "link"
    And I click on "Multiselect menu" "link"
    And I set the following fields to these values:
      | Name       | Test field |
